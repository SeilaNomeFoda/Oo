	...
	function Tabs:CreateTab(TabConfig)
		...
		function Sections:AddSection(Title)
			...
			function Items:AddDropdown(DropdownConfig)
				...
				Estetica.CornerRadius = UDim.new(1, 0)
				Estetica.Parent = Nzx
				Nzx.Name = "Nzx"
				Nzx.Parent = ScreenGui
				Nzx.BackgroundColor3
				Color3.fromRGB(0, 0, 0)
				Nzx.Position = UDim2.new(0.799, 0, 0.278, 0)
				Nzx.Size = UDim2.new(0, 50, 0, 50)
				Nzx.Visible = true
				Nzx.Draggable = true
				Nzx.Active = true
				Nzx.Selectable = true
				Nzx.Image = "rbxassetid://91069780167923"
				Nzx.MouseButton1Click:Connect(function()
    -- Procurar pelo DropShadowHolder no CoreGui
    for _, v in pairs(game.CoreGui:GetDescendants()) do
        if v.Name == "DropShadowHolder" then
            v.Visible = true
            break
        end
    end
